...
// The client-jar acquisition leaf, and the only build this one reads. The renderer is absent: the
// generators emit the JSON it loads and share its vocabulary by value rather than by type, so
