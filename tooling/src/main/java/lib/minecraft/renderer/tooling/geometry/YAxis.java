 ...
 * half-block band. The marker travels with the emitted bones in their native frame - nothing
 * is pre-flipped at tooling time - and the render-time presentation applies the source Y-up
 * to block-space orientation.
 *
 * <p>The axis convention is per-geometry data shared by both geometry-emitting flows.
 */
public enum YAxis {
