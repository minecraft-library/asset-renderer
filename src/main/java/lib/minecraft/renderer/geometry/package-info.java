 ...
 * <ul>
 *   <li>{@link lib.minecraft.renderer.geometry.BlockFace} - block-model UV unwrap with the
 ...
 *   <li>{@link lib.minecraft.renderer.geometry.EntityFace} - entity-cube UV unwrap (strip
 ...
 *   <li>{@link lib.minecraft.renderer.geometry.SkinFace} - 64x64 player-skin atlas UV layout
 ...
 *   <li>{@link lib.minecraft.renderer.geometry.SixFaces} - small immutable holder of one
 ...
 * <ul>
 *   <li>{@link lib.minecraft.renderer.geometry.ProjectionMath} - 2D rasterization math:
 ...
 *       inner loop.</li>
 *   <li>{@link lib.minecraft.renderer.geometry.Box} - immutable axis-aligned bounding box,
 ...
 *   <li>{@link lib.minecraft.renderer.geometry.EulerRotation} - immutable
 ...
 *       matrices.</li>
 *   <li>{@link lib.minecraft.renderer.geometry.PerspectiveParams} - perspective vs orthographic
 *       blend (vanilla item icons are orthographic, blocks use a slight perspective tilt).
 *       Passed to every {@code rasterize} call.</li>
 *   <li>{@link lib.minecraft.renderer.geometry.Biome} - the four cardinal biome categories
