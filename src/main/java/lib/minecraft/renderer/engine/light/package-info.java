 ...
 * {@code Lighting.Entry}). Kits bake a per-face or per-vertex shade scalar into each
 * {@link lib.minecraft.renderer.engine.raster.VisibleTriangle VisibleTriangle} at build time.
 *
