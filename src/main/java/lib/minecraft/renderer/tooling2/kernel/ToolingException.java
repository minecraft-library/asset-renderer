...
/**
 * Thrown when a tooling2 flow cannot read its inputs, a required class or member is missing
 * from the client jar, or a fatal derivation fails.
 *
 * <p>The single failure type of the tooling2 kernel (one error contract everywhere - SPINE
