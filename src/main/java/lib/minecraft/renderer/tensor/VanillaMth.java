...
/**
 * Bit-exact reproductions of the vanilla {@code net.minecraft.util.Mth} scalar helpers a skeletal
 * pose evaluation reaches, alongside the 65536-entry sine table its trigonometry is sampled from.
 *
 ...
 * the bit level, and a pose is composed of thousands of these before it reaches a pixel.
 *
