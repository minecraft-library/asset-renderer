 ...
 * {@link Quaternionf#rotationXYZ Quaternionf.rotationXYZ} produces
 * bit-identical floats to {@code new org.joml.Quaternionf().rotationXYZ(...)} in the vanilla
 * harness, and converting it through
 * {@link Quaternionf#toMatrix4f Quaternionf.toMatrix4f} produces
 * the same {@link Matrix4f Matrix4f} as
 ...
 * <p><b>Types.</b>
 * <ul>
 *   <li>{@link Vector2f Vector2f} - immutable
 ...
 *   <li>{@link Vector3f Vector3f} - immutable
 *       {@code (x, y, z)} record. Model-space positions, surface normals, scale triples.
 *       {@link Vector3f#transform Vector3f.transform} /
 *       {@link Vector3f#transformNormal transformNormal}
 *       silently dispatch to a JDK Vector API implementation when the {@code jdk.incubator.vector}
 *       module is loaded.</li>
 *   <li>{@link Vector4f Vector4f} - homogeneous
 ...
 *   <li>{@link Matrix4f Matrix4f} - immutable column-major 4x4
 ...
 *       {@link Matrix4f#multiply multiply} silently dispatches
 *       to SIMD.</li>
 *   <li>{@link Quaternionf Quaternionf} - immutable
 ...
 *       {@link EntityGeometryKit EntityGeometryKit}.</li>
 * </ul>
 *
 * <p><b>SIMD dispatch.</b>
 * <ul>
 *   <li>{@link SimdSupport SimdSupport} is the runtime probe.
 *       It does a single {@link Class#forName(String, boolean, ClassLoader) Class.forName} on
 ...
 *       including the {@link NoClassDefFoundError} a JVM started without
 ...
 *   <li>{@link SimdOps SimdOps} is the implementation. It
 ...
 *       {@link SimdSupport#ENABLED SimdSupport.ENABLED} and
 ...
 * {@link PipelineGsonContributor PipelineGsonContributor} SPI
...
import lib.minecraft.renderer.pipeline.PipelineGsonContributor;
import lib.minecraft.renderer.tensor.Matrix4f;
import lib.minecraft.renderer.tensor.Quaternionf;
import lib.minecraft.renderer.tensor.SimdOps;
import lib.minecraft.renderer.tensor.SimdSupport;
