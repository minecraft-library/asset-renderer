...
/**
 * Classifies {@code special}-node kinds against the render paths this repo already owns (05-models.md
 * §3.4). Every 26.1 vanilla special kind maps onto an existing dispatcher: {@code bed} / {@code chest}
 ...
 *
 * <p>Special rendering is parse-and-hold this phase: at the neutral context every vanilla special item
...
public class SpecialKinds {
    ...
    /** The special kinds vanilla 26.1 ships, each mapped onto an existing render path (05 §3.4). */
     ...
     * drops it (empty) - the no-fallback contract for special nodes (05 §3.4).
     *
