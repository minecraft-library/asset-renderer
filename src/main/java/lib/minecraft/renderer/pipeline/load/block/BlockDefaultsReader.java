...
/**
 * The native v2 reader for per-block default states, replacing
 * {@code BlockStateLoader.loadDefaultStateKeys}'s comma-joined-string parse.
 *
 * <p>{@code v2/block_defaults.json} carries the structured shape (decision 24): {@code blocks{}} maps
...
public final class BlockDefaultsReader {
    ...
    /**
     * Reads the per-block default-state key map natively from {@code v2/block_defaults.json}.
     *
