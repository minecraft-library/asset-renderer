...
public final class EntityDiagnosticsWriter {
     ...
     *
     * @param options the pipeline options for the {@code source_version} stamp
    ...
    /**
     * Assembles the discovery diagnostic document: the shared {@code "//"} + {@code source_version}
    ...
    private static @NotNull JsonObject buildDiscoveryDoc(
        ...
        JsonObject root = ToolingJson.header(
            "Generated by ToolingEntityModels. Discovery + per-entity-binding diagnostic - lists living mobs from EntityRegistryDiscovery and their detected renderer + model classes. Run ./gradlew :asset-renderer:entityModels to refresh.",
            options.getVersion());
    ...
    /**
     * Assembles the geometry diagnostic document: the shared {@code "//"} + {@code source_version}
    ...
    private static @NotNull JsonObject buildGeometryDoc(
        ...
        JsonObject root = ToolingJson.header(
            "Generated by ToolingEntityModels. Per-entity geometry from Java client jar bytecode (LayerDefinition.create / CubeListBuilder / PartPose / addOrReplaceChild walked via the shared block-entity Parser). Frame is vanilla Java's natural Y-DOWN.",
            options.getVersion());
