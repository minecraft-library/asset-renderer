...
public final class Timeline {
     ...
     */
    public @NotNull Timeline swing(@NotNull Turn axis, double fromDegrees, double toDegrees) {
     ...
     * @return this timeline
     */
    public @NotNull Timeline bob(double pixels) {
     ...
     * @return this timeline
     */
    public @NotNull Timeline keyframe(double atSeconds, double pitchDegrees, double yawDegrees, double rollDegrees) {
     ...
     * @return this timeline
     */
    public @NotNull Timeline shift(double atSeconds, double xPixels, double yPixels, double zPixels) {
     ...
     * @return this timeline
     */
    public @NotNull Timeline over(double seconds) {
     ...
     * @return this timeline
     */
    public @NotNull Timeline ease(@NotNull Ease ease) {
        this.ease = ease;
        return this;
    }
