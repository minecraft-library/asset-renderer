 ...
 * {@link Renderer renderer} layer can stay a thin dispatch surface and
 * the {@link ModelEngine engine} layer never sees asset-shaped
 * data.
 *
 ...
 * <ul>
 *   <li>{@link BlockGeometryKit} - the {@code block/*.json}
 ...
 *       {@link BlockFace BlockFace} UV unwrap and
 *       {@code AmbientOcclusionFace} lighting scalar baked in.</li>
 *   <li>{@link EntityGeometryKit} - the entity {@code ModelPart}
 *       chain builder. Consumes the
 *       {@link ToolingEntityModels ToolingEntityModels}-produced
 *       {@code entity_geometry.json} and walks bone hierarchies, cube inflations, pivot
 *       rotations, and {@link EntityFace EntityFace} UV
 ...
 *   <li>{@link FluidGeometryKit} - vanilla fluid cube (1x1x1 with
 ...
 * <ul>
 *   <li>{@link ArmorKit} - composites the four humanoid armor
 ...
 *   <li>{@link BannerKit} - banner / shield pattern stack
 ...
 *   <li>{@link GlintKit} - enchantment glint animator. Reproduces
 ...
 *   <li>{@link TrimKit} - armor trim palette permutation. Maps the
 ...
 *       overrides.</li>
 *   <li>{@link ItemStackKit} - durability bar and stack count
 ...
 * <ul>
 *   <li>{@link TextKit} - styled Minecraft text rendering: font
 ...
 *   <li>{@link ObfuscationKit} - per-frame deterministic glyph
 ...
 *   <li>{@link FrameMerger} - composes static and animated layers
