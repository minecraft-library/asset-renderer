 ...
 * <ul>
 *   <li>{@link lib.minecraft.renderer.kit.BlockGeometryKit} - the {@code block/*.json}
 ...
 *   <li>{@link lib.minecraft.renderer.kit.EntityGeometryKit} - the entity {@code ModelPart}
 ...
 *   <li>{@link lib.minecraft.renderer.kit.FluidGeometryKit} - vanilla fluid cube (1x1x1 with
 ...
 * <ul>
 *   <li>{@link lib.minecraft.renderer.kit.ArmorKit} - composites the four humanoid armor
 ...
 *   <li>{@link lib.minecraft.renderer.kit.BannerKit} - banner / shield pattern stack
 ...
 *   <li>{@link lib.minecraft.renderer.kit.GlintKit} - enchantment glint animator. Reproduces
 ...
 *   <li>{@link lib.minecraft.renderer.kit.TrimKit} - armor trim palette permutation. Maps the
 ...
 *       ships.</li>
 *   <li>{@link lib.minecraft.renderer.kit.AnimationKit} - {@code .mcmeta} frame strip
 *       playback (vertically stacked frames, per-entry duration override, optional linear
 *       interpolation between adjacent frames).</li>
 *   <li>{@link lib.minecraft.renderer.kit.RedstoneKit} - the 16-entry redstone-wire-by-power
 ...
 *       overrides.</li>
 *   <li>{@link lib.minecraft.renderer.kit.ItemStackKit} - durability bar and stack count
 ...
 * <ul>
 *   <li>{@link lib.minecraft.renderer.kit.TextKit} - styled Minecraft text rendering: font
 ...
 *   <li>{@link lib.minecraft.renderer.kit.ObfuscationKit} - per-frame deterministic glyph
 ...
 *   <li>{@link lib.minecraft.renderer.kit.FrameMerger} - composes static and animated layers
