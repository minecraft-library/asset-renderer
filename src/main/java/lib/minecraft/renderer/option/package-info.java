 ...
 * {@link lib.minecraft.renderer.option.Option Option} marker that bounds
 * {@link lib.minecraft.renderer.Renderer Renderer}'s type parameter.
 * <p>
 * The composable sub-option value objects the bags nest - the render frame, worn armor, and player
