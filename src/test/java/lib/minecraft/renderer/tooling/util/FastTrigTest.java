...
/**
 * Pins {@link FastTrig} as a bit-identical reproduction of vanilla's {@code Mth.sin} / {@code Mth.cos}
 * 65536-entry table lookup.
 *
 ...
 *       runtime would produce (see {@link FastTrig} class doc for the WitherBoss tail-pivot drift
 *       that motivates it).
 * </ul>
 */
...
class FastTrigTest {
    ...
    /**
     * Re-derives vanilla's {@code Mth.sin} index math independently of {@link FastTrig}: scale by
     * {@link #RATIO}, narrow {@code double -> long -> int}, mask to the low 16 bits, then sample
     * {@code Math.sin} at the quantized angle. Sampling {@code Math.sin} directly (rather than
