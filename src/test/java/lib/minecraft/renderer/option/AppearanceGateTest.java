...
/**
 * Every sealed arm of {@link AppearanceGate} against the {@link EntityAppearance} selection that fires
...
class AppearanceGateTest {
    ...
    private static final List<ArmCase> ARMS = List.of(
        new ArmCase(new AppearanceGate.StateGate("tame"),
            EntityAppearance.builder().state(Optional.of("tame")).build(),
            EntityAppearance.defaults()),
        new ArmCase(new AppearanceGate.FlagGate("sheared", true),
            EntityAppearance.builder().sheared(true).build(),
            EntityAppearance.defaults()),
        new ArmCase(new AppearanceGate.ChargedGate(),
            EntityAppearance.builder().charged(true).build(),
            EntityAppearance.defaults()),
        new ArmCase(new AppearanceGate.TintedGate("wool_color", UNDERCOAT_TINT),
            EntityAppearance.builder().tints(Map.of(TintAxis.WOOL, DyeColor.Vanilla.RED)).build(),
            EntityAppearance.defaults()),
        new ArmCase(new AppearanceGate.EquipmentGate("saddle"),
            EntityAppearance.builder().equipment(Map.of("saddle", "")).build(),
            EntityAppearance.defaults()),
        new ArmCase(new AppearanceGate.MarkingsGate(),
            EntityAppearance.builder().markings(HorseMarking.WHITE_DOTS).build(),
            EntityAppearance.defaults()),
        ...
        new ArmCase(new AppearanceGate.SizeGate(Size.SMALL),
            EntityAppearance.builder().size(Optional.of(Size.SMALL)).build(),
            EntityAppearance.defaults()));
    ...
    class Tinted {
        ...
        void staysSilentWithNoDye() {
            ...
            assertThat(gate.test(EntityAppearance.defaults()), is(false));
        }
        ...
        void staysSilentForTheBakedTint() {
            ...
            AppearanceGate gate = new AppearanceGate.TintedGate("wool_color", UNDERCOAT_TINT);
            EntityAppearance white = EntityAppearance.builder()
        ...
        void firesForADifferingDye() {
            ...
            for (DyeColor.Vanilla dye : DyeColor.Vanilla.values()) {
                EntityAppearance dyed = EntityAppearance.builder().tints(Map.of(TintAxis.WOOL, dye)).build();
        ...
        void comparesTheAxisResolve() {
            ...
            EntityAppearance red = EntityAppearance.builder()
        ...
        void readsOnlyItsOwnAxis() {
            AppearanceGate gate = new AppearanceGate.TintedGate("wool_color", UNDERCOAT_TINT);
            EntityAppearance elsewhere = EntityAppearance.builder()
        ...
        void comparesACustomDyeByColour() {
            AppearanceGate gate = new AppearanceGate.TintedGate("wool_color", UNDERCOAT_TINT);
            EntityAppearance same = EntityAppearance.builder()
                .tints(Map.of(TintAxis.WOOL, DyeColor.of(0xE6E6E6)))
                .build();
            EntityAppearance other = EntityAppearance.builder()
        ...
        void neverFiresOnAnUnownedToken() {
            ...
            EntityAppearance dyed = EntityAppearance.builder()
    ...
    class Flag {
        ...
        void answersTheShearedFlag() {
            EntityAppearance woolly = EntityAppearance.defaults();
            EntityAppearance shorn = EntityAppearance.builder().sheared(true).build();
        ...
        void readsAnUnknownTokenAsFalse() {
            ...
            assertThat("an unknown token asked for false renders whatever the appearance holds",
                new AppearanceGate.FlagGate("glowing", false).test(EntityAppearance.defaults()), is(true));
            ...
            assertThat("an unknown token asked for true never renders",
                new AppearanceGate.FlagGate("glowing", true).test(EntityAppearance.defaults()), is(false));
     ...
     */
    private record ArmCase(AppearanceGate gate, EntityAppearance fires, EntityAppearance silent) {}
