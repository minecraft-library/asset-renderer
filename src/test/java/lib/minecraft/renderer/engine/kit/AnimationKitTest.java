...
/**
 * Coverage of {@link AnimationKit#sampleFrame} playback of a resolved {@link Flipbook} over a
 ...
 * {@link MCMeta.Frame} durations, plus {@link AnimationKit#extractFrame} row
...
class AnimationKitTest {
    ...
    void singleFrameStrip_returnsSameFrame() {
        ...
        PixelBuffer frame0 = AnimationKit.sampleFrame(strip, flipbook, 0);
        PixelBuffer frame5 = AnimationKit.sampleFrame(strip, flipbook, 5);
    ...
    void fourFrameStrip_samplesByTick() {
        ...
        PixelBuffer f0 = AnimationKit.sampleFrame(strip, flipbook, 0);
        PixelBuffer f1 = AnimationKit.sampleFrame(strip, flipbook, 1);
        PixelBuffer f2 = AnimationKit.sampleFrame(strip, flipbook, 2);
        PixelBuffer f3 = AnimationKit.sampleFrame(strip, flipbook, 3);
    ...
    void tick_wrapsModuloCycle() {
        ...
        PixelBuffer f0 = AnimationKit.sampleFrame(strip, flipbook, 0);
        PixelBuffer f4 = AnimationKit.sampleFrame(strip, flipbook, 4);
        PixelBuffer fNeg1 = AnimationKit.sampleFrame(strip, flipbook, -1);
    ...
    void frametime_holdsFrameRange() {
        ...
        PixelBuffer t0 = AnimationKit.sampleFrame(strip, flipbook, 0);
        PixelBuffer t2 = AnimationKit.sampleFrame(strip, flipbook, 2);
        PixelBuffer t3 = AnimationKit.sampleFrame(strip, flipbook, 3);
        PixelBuffer t5 = AnimationKit.sampleFrame(strip, flipbook, 5);
    ...
    void explicitFrameList_respectsEntryDurations() {
        ...
        assertThat(AnimationKit.sampleFrame(strip, flipbook, 0).getPixel(0, 0), equalTo(0xFFAAAAAA));
        assertThat(AnimationKit.sampleFrame(strip, flipbook, 4).getPixel(0, 0), equalTo(0xFFAAAAAA));
        assertThat(AnimationKit.sampleFrame(strip, flipbook, 5).getPixel(0, 0), equalTo(0xFFBBBBBB));
        assertThat(AnimationKit.sampleFrame(strip, flipbook, 6).getPixel(0, 0), equalTo(0xFFBBBBBB));
        // Cycle is 7 ticks, wraps back to frame 0
        assertThat(AnimationKit.sampleFrame(strip, flipbook, 7).getPixel(0, 0), equalTo(0xFFAAAAAA));
    }
