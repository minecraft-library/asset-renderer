...
class EntityModelSourceEquivalenceTest {
    ...
    void v2CarriesBabyTextures() {
        ...
        assertThat("an enum-variant entity falls back to the <adult>_baby naming convention",
            v2.get("minecraft:axolotl").stateTextures().get("baby"), is("axolotl/axolotl_lucy_baby"));
