 ...
 * {@code FluidRenderDriver}'s {@code water_animated_iso}) and {@code minecraft:fire} is not in the block
...
public final class BlockFlipbookDriver {
    ...
    /** Where the GIF, the sampled stills and the derived-static PNGs land. */
