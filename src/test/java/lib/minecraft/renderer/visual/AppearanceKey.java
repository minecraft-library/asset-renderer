...
public record AppearanceKey(@NotNull String entityId,
    ...
    public enum Axis {
        ...
        /** Whether a key may carry more than one token of this axis. */
        ...
        public static @NotNull List<String> tokens() {
            return java.util.Arrays.stream(values()).map(Axis::token).toList();
        }
    }
}
