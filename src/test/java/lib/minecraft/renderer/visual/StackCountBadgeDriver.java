...
public final class StackCountBadgeDriver {
     ...
     *
     * @param args {@code diff=<labelA>,<labelB>} runs the pixel diff over the two named label
     *     directories. Any other value, or none at all, is treated as a label and renders every
     *     {@code (size, count)} pair under that label's directory
