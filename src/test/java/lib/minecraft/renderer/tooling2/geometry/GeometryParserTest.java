...
class GeometryParserTest {
    ...
    void manifestDedupeAndKeys() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(
            lib.minecraft.renderer.tooling2.kernel.ToolingException.class,
    ...
    void zipImportGate() throws Exception {
        java.nio.file.Path root = java.nio.file.Path.of("src/main/java/lib/minecraft/renderer/tooling2");
