...
/**
 * Pins the tooling2 parser's nested {@code FastTrig} to vanilla {@code Mth.sin / Mth.cos}
 ...
 * math independently.
 */
@DisplayName("tooling2 FastTrig bit-parity vs an independent vanilla Mth re-derivation")
