...
| `digest.shipped-tables` | `digests/shipped-tables.json` | 11 | 11 entries | `b116041bcb33507dfe88cdb7f00449581322b9f0` | yes |
| `manifest.dump.packs` | `manifests/dump-packs.json` | 14 | 14 entries | `b116041bcb33507dfe88cdb7f00449581322b9f0` | yes |
| `manifest.dump.vanilla` | `manifests/dump-vanilla.json` | 14 | 14 entries | `b116041bcb33507dfe88cdb7f00449581322b9f0` | yes |
...
| `manifest.tooling-tables` | `manifests/tooling-tables.json` | 11 | 11 entries | `b116041bcb33507dfe88cdb7f00449581322b9f0` | yes |
