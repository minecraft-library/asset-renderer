...
| `sweep.entity-animation` | sweep-table | STORE | `entityAnimationParityVanilla` | 2 | 2 | 90 | 36284 ms | yes |
| `manifest.references` | manifest | STORE | `renderVanillaAllReferences` | 2 | 2 | 3042 | 137296 ms | yes |
| `manifest.visual` | manifest | STORE | `visualSweepSet` | 2 | 2 | 210 | - | yes |
| `manifest.player-raw` | manifest | STORE | `playerRawSweepSet` | 2 | 2 | 18 | - | yes |
| `manifest.dump.vanilla` | manifest | STORE | `parityDump` | 2 | 2 | 14 | 28775 ms | yes |
| `manifest.dump.packs` | manifest | STORE | `parityDump` | 2 | 2 | 14 | 28775 ms | yes |
...
| `manifest.tooling-tables` | manifest | STORE | `entityModels`, `blockModels`, `blockDefaults`, `blockItems`, `blockTints`, `potionColors`, `glintItems`, `colorMaps` | 2 | 2 | 11 | 64466 ms | yes |
