...
| `sweep.entity-animation` | sweep-table | STORE | `entityAnimationParityVanilla` | 2 | 2 | 90 | 21544 ms | yes |
| `manifest.references` | manifest | STORE | `renderVanillaAllReferences` | 2 | 2 | 3042 | 140210 ms | yes |
| `manifest.visual` | manifest | STORE | `visualSweepSet` | 2 | 2 | 210 | - | yes |
| `manifest.player-raw` | manifest | STORE | `playerRawSweepSet` | 2 | 2 | 18 | - | yes |
| `manifest.dump.vanilla` | manifest | STORE | `parityDump` | 5 | 5 | 14 | 28360 ms | yes |
| `manifest.dump.packs` | manifest | STORE | `parityDump` | 5 | 5 | 14 | 28360 ms | yes |
...
| `manifest.tooling-tables` | manifest | STORE | `entityModels`, `blockModels`, `blockDefaults`, `blockItems`, `blockTints`, `potionColors`, `glintItems`, `colorMaps` | 2 | 2 | 11 | 44324 ms | yes |
